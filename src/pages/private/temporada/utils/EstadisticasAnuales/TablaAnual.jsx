        ...
        <table className="w-full text-[11px] border-collapse table-fixed">
          <thead>
            <tr className="bg-slate-100 border-b border-slate-200 text-[9px] uppercase text-slate-500 font-bold">
              <th className="w-[8%] px-1 py-2 text-center">Pos</th>
              <th className="w-[25%] px-2 py-2 text-left">Jugador</th>
              <th className="w-[18%] px-2 py-2 text-left">Club</th>
              <th className="w-[10%] px-1 py-2 text-center">Año</th>
              <th className="w-[10%] px-1 py-2 text-center">G</th>
              <th className="w-[10%] px-1 py-2 text-center">PJ</th>
              <th className="w-[19%] px-1 py-2 text-center">Prom</th>
            </tr>
          </thead>
          <tbody>
            {list.length === 0 ? (
              ...
              list.map((j, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 py-2 text-left font-semibold text-slate-800 truncate whitespace-nowrap overflow-hidden">
                      {prettySafe(j.name)}
                    </td>
                    <td className="px-2 py-2 text-left text-slate-600 truncate whitespace-nowrap overflow-hidden">
                      {prettySafe(j.club)}
                    </td>
