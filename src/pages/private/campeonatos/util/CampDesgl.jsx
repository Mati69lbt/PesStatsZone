...
const RESULT_OPTIONS = [
  ...
  { value: "11vo", label: "Undécimo" },
  { value: "12vo", label: "Duodécimo" },
  { value: "13ro", label: "Decimotercero" },
  { value: "14to", label: "Decimocuarto" },
  { value: "15to", label: "Decimoquinto" },
  { value: "16to", label: "Decimosexto" },
  { value: "17mo", label: "Decimoséptimo" },
  { value: "18vo", label: "Decimoctavo" },
  { value: "19no", label: "Decimonoveno" },
  { value: "20mo", label: "Vigésimo" },
  { value: "21ro", label: "Vigésimo Primero" },
  { value: "22do", label: "Vigésimo Segundo" },
  { value: "23ro", label: "Vigésimo Tercero" },
  { value: "24to", label: "Vigésimo Cuarto" },
  { value: "25to", label: "Vigésimo Quinto" },
];
