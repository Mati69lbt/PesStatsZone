...
export const useRachasEmpatadas = (lineups = {}) => {
  return useMemo(() => {
    ...
    Object.keys(lineups).forEach((clubKey) => {
      ...
      partidosOrdenados.forEach((partido, index) => {
        ...
        if (resultadoFinal === "empatado") {
          ...
          // Ganar o perder corta la racha de empates
    ...
    // Ordenamos de mayor a menor cantidad de empates seguidos
    return resultado.sort((a, b) => b.rachaEmpates - a.rachaEmpates);
  }, [lineups]);
};
